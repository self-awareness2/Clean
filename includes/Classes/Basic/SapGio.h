...
protected:
   ...
   static SAPSTATUS CCONV GioCallback8(void *context, UINT32 eventType, UINT32 eventCount)
      { return GioCallback(context, (EventType) eventType, eventCount, 8); }
   static SAPSTATUS CCONV GioCallback9(void *context, UINT32 eventType, UINT32 eventCount)
      { return GioCallback(context, (EventType) eventType, eventCount, 9); }
   static SAPSTATUS CCONV GioCallback10(void *context, UINT32 eventType, UINT32 eventCount)
      { return GioCallback(context, (EventType) eventType, eventCount, 10); }
   static SAPSTATUS CCONV GioCallback11(void *context, UINT32 eventType, UINT32 eventCount)
      { return GioCallback(context, (EventType) eventType, eventCount, 11); }
   static SAPSTATUS CCONV GioCallback12(void *context, UINT32 eventType, UINT32 eventCount)
      { return GioCallback(context, (EventType) eventType, eventCount, 12); }
   static SAPSTATUS CCONV GioCallback13(void *context, UINT32 eventType, UINT32 eventCount)
      { return GioCallback(context, (EventType) eventType, eventCount, 13); }
   static SAPSTATUS CCONV GioCallback14(void *context, UINT32 eventType, UINT32 eventCount)
      { return GioCallback(context, (EventType) eventType, eventCount, 14); }
   static SAPSTATUS CCONV GioCallback15(void *context, UINT32 eventType, UINT32 eventCount)
      { return GioCallback(context, (EventType) eventType, eventCount, 15); }
   ...
   static SAPSTATUS CCONV GioCallback8Ex(void *context, COREVENTINFO eventInfo)
      { return GioCallbackEx(context, eventInfo, 8); }
   static SAPSTATUS CCONV GioCallback9Ex(void *context, COREVENTINFO eventInfo)
      { return GioCallbackEx(context, eventInfo, 9); }
   static SAPSTATUS CCONV GioCallback10Ex(void *context, COREVENTINFO eventInfo)
      { return GioCallbackEx(context, eventInfo, 10); }
   static SAPSTATUS CCONV GioCallback11Ex(void *context, COREVENTINFO eventInfo)
      { return GioCallbackEx(context, eventInfo, 11); }
   static SAPSTATUS CCONV GioCallback12Ex(void *context, COREVENTINFO eventInfo)
      { return GioCallbackEx(context, eventInfo, 12); }
   static SAPSTATUS CCONV GioCallback13Ex(void *context, COREVENTINFO eventInfo)
      { return GioCallbackEx(context, eventInfo, 13); }
   static SAPSTATUS CCONV GioCallback14Ex(void *context, COREVENTINFO eventInfo)
      { return GioCallbackEx(context, eventInfo, 14); }
   static SAPSTATUS CCONV GioCallback15Ex(void *context, COREVENTINFO eventInfo)
      { return GioCallbackEx(context, eventInfo, 15); }
