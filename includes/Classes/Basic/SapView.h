...
public:
   ...
   // Management of display pages. This applies to planar and multi-format buffers,
   // and also to buffer types like RGB8888 (to display RGB and mono separately).
...
protected:
   ...
   // Management of display pages. This applies to planar and multi-format buffers,
   // and also to buffer types like RGB8888 (to display RGB and mono separately).
   int m_NumPages;            // Number of display pages
   SapFormat *m_PageFormat;   // Individual formats of display pages
