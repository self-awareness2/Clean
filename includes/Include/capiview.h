...
//*-----------------------------------------------------------------------*/
// Display pages when applicable (e.g. RGB or alpha for RGB8888)
//*-----------------------------------------------------------------------*/
#define CORVIEW_PRM_NPAGES                      CORVIEW_PRM( 42, 4)
#define CORVIEW_PRM_PAGE                        CORVIEW_PRM( 43, 4)
#define CORVIEW_PRM_PAGE_FORMAT                 CORVIEW_PRM( 44, 64)

#define CORVIEW_PRM_LAST   /* last valid + 1 */		( 45 + CORVIEW_PRM_FIRST)
/*------------------------------------------------------------------------*/
